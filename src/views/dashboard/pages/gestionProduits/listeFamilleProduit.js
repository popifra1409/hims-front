...
const listeFamilleProduit = () => {
    return (
        <Dashboard>
                < PageHeading heading="Liste Famille produit" />
                                ...
                                <div className="row" >
                                    ...
                                    <div className="col-sm-5" >
                                        <div className="d-grid gap-2 d-md-flex justify-content-md-end" >
                                            ...
                                            <Link to={{ pathname: '/dashboard/listeFamilleProduit/familleProduit' }} className="btn btn-primary w-100  ">Ajouter Famille<BiAddToQueue style={{ marginLeft: '3px' }} /> </Link>
                                        </div>
                                    </div>
...
export default listeFamilleProduit
