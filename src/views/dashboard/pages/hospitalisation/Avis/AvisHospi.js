...
const AvisHospi = () => {
  return (
    <Dashboard>
      <PageHeading heading="Hospitalisation" stepName={'Faire un avis'} />
      <div className="container">
            ...
            <div className="p-3 row border rounded">
              ...
              <div className="col-md-4 mb-2 text-start">
                ...
                <select className="form-select" name="prestation">
                  <option value="">Faites un choix</option>
                  <option value="">MEDECIN 1</option>
                  <option value="">MEDECIN 2</option>
                  <option value="">MEDECIN 3</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div className="mb-3 p-2">
          <button className="btn btn-success text-wrap mx-2" style={{ width: '7rem' }}>Envoyer</button>
          {/* <Link to='/dashboard/hospitalisation/avis' className="mx-3 btn btn-light border text-wrap" style={{ width: '6rem' }}>Avis</Link> */}
          <button className=" btn btn-danger text-wrap mx-2" style={{ width: '6rem' }}>Annuler</button>
        </div>
      </div>
    </Dashboard>
  )
